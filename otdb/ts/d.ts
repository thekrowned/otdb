// https://github.com/ConnorJamesLow/texsaur/blob/main/package/types/jsx.d.ts
/// <reference lib="dom" />
...
declare namespace JSX {
    ...
    type AllHTMLElementTagNameMap = HTMLElementTagNameMap & {
        "form-input": null;
    };

    type IntrinsicElementMap =
        {
            [K in keyof AllHTMLElementTagNameMap]: HTMLElementCommonAttributes & GlobalAttributes & Record<string, any>;
        } & {
            [K in keyof SVGElementTagNameMap]: GlobalAttributes & Record<string, any>;
        };

    type Tag = keyof JSX.IntrinsicElements
    type HTMLTag = keyof AllHTMLElementTagNameMap;
...
type AllElementTagNameMap = JSX.AllHTMLElementTagNameMap & SVGElementTagNameMap;
